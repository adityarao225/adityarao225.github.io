...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <!-- <p><b class="pr-2">Email</b>adityarao2110@gmail.com</p> -->
        <p>
            <b class="pr-2">Email</b>
            <a href="mailto:adityarao2110@gmail.com" target="_blank" class="text-violet-400"
                >adityarao2110<sup class=""
        ...
        <p>
            ...
            <a href=" https://github.com/adityarao225/ " target="_blank" class="text-violet-400"
                >adityarao225<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/adityarao225/" target="_blank" class="text-violet-400"
                >Aditya_Rao<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
